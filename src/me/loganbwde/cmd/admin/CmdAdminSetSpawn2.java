...
public class CmdAdminSetSpawn2
{
    ...
    public CmdAdminSetSpawn2(main main)
    {
        m = main;
    }
    ...
    public void setspawn(Player p,String[] args)
    {
        ...
        try
        {
            ...
            else
            {
                ...
                m.statement.executeUpdate("UPDATE " + m.tablename3 + " SET spawn2 = '" + l + "' WHERE name='" + args[2] + "';");
                m.getMessagesManager().sendMessage(p, m.getFileManager().getMessageEntrys().get("Messages.spawn2set"));
                sucess = true;
            }
        }
